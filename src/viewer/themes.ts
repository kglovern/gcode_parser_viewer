import type { GCodeViewerTheme } from "./types";

export type GCodeViewerThemePresetName =
  | "dark"
  | "light"
  | "flexoki-dark"
  | "tokyo-night"
...
export const gCodeViewerThemePresets: Record<GCodeViewerThemePresetName, GCodeViewerTheme> = {
  dark: {
    background: "#111827",
    opacity: 0.9,
    rapidOpacity: 0.3,
