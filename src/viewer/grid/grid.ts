...
function createLineSegments(vertices: number[], color: string, opacity: number): any {
...
export function disposeLineSegmentsGroup(group: any): void {
...
export function disposeAxesGroup(group: any): void {
  group.traverse((child: any) => {
