...
export function createBoundingBoxGroup(bounds: THREE.Box3, options: GCodeViewerOptions): THREE.Group {
...
export function disposeBoundingBoxGroup(group: THREE.Object3D): void {
