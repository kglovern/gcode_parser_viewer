...
import { GCodeVirtualizer as iB, buildWorkerToolpathStreams as Oe, buildToolpathGeometryFromLinesBatched as Le, buildMovementVerticesFromLines as Me, buildWorkerSegmentGroups as He } from "./gviewer.js";
...
function Fe(i) {
  ...
  for (const B of i.specs) {
    if (B.positions.length === 0 || B.opacity <= 0)
      continue;
    const A = B.positions.length / 3, e = B.colors ? B.colors.slice() : NA(B.kind, A, i.options), P = new Float32Array(e.length);
    P.set(e);
...
function Ge(i, Q) {
  for (const t of i) {
    ...
    const B = NA(t.kind, t.totalVertices, Q);
...
function be(i) {
  const Q = rB(i.options.render.theme.rapidOpacity ?? 0.3);
...
function pe(i) {
  ...
  if (t === B)
    return;
  const A = i.stream.line.geometry.getAttribute("color"), e = ge(i.options), P = Math.min(B, t), r = Math.max(B, t);
  if (t > B)
    for (let s = B; s < t; s += 1) {
      const v = s * 3;
...
function me(i) {
  if (i.bucketCount <= 1)
    return rB(i.baseOpacity);
  const Q = i.bucketIndex / (i.bucketCount - 1);
  return rB(i.baseOpacity * Q);
}
function rB(i) {
...
function Yt(i, Q) {
  ...
  for (const e of Q.moves)
    e.lineIndex > t && e.lineIndex <= i && sB(e, A, Q.slabBounds, Q.toolRadius, Q.resolution);
  return A;
}
function Vt(i, Q, t, B) {
  if (t <= 0) return;
...
function Ye(i, Q) {
  ...
  const B = i.xMax - i.xMin, A = i.yMax - i.yMin, e = i.zTop - i.zBot, P = (i.xMin + i.xMax) / 2, r = (i.yMin + i.yMax) / 2, s = (i.zBot + i.zTop) / 2, v = Se();
...
function We(i, Q) {
  ...
  return A.transparent = !0, A.opacity = 0.65, A.depthWrite = !1, A.linewidth = 2, t.add(B), Q.boundingBox.labels && t.add(...qe(i.clone(), Q)), t;
}
function qe(i, Q) {
  const t = Q.render.theme.colors.boundingBox, B = 0.8, A = (u) => Math.abs(u) < 1e-9 ? "0" : u.toFixed(3), e = (u) => Q.units === "in" ? `${A(u / Ze)} in` : `${A(u)} mm`, P = i.min, r = i.max, s = (u) => MQ(u, t, { size: 4, opacity: B }), v = s(e(P.x)), c = s(e(r.x)), n = s(e(P.y)), T = s(e(r.y)), z = s(e(P.z)), a = s(e(r.z)), o = new l.Vector3();
  i.getSize(o);
...
function QP(i, Q, t, B) {
  const A = new l.Group();
  if (A.add(WB(i, Q, t.render.theme.colors.machineBed)), B) {
...
class BP extends XB {
  _rotateUp(Q) {
    XB.prototype._rotateUp.call(this, -Q);
  }
}
function AP(i) {
...
function _B(i, Q, t = 1.25) {
  const B = Math.max(i.x, i.y, 1) / 2;
  return OA(B * 2, Q) * t + i.z;
}
function Rt(i, Q) {
...
function rP(i) {
  const { minX: Q, maxX: t, minY: B, maxY: A } = DB(i), e = i.units === "mm" ? 10 : LA, P = [], r = [], s = (a, o, w, E, h) => {
    h.push(a, o, 0, w, E, 0);
  ...
  const z = new l.Group();
  return r.length > 0 && z.add(tA(r, i.theme.colors.grid.minor, 0.25)), P.length > 0 && z.add(tA(P, i.theme.colors.grid.major, 0.4)), z;
}
function tA(i, Q, t) {
...
function vP(i) {
  const Q = new l.Group(), { minX: t, maxX: B, minY: A, maxY: e } = DB({
...
function nP(i) {
  const Q = new l.Group(), { minX: t, maxX: B, minY: A, maxY: e } = DB(i), P = i.units === "mm" ? 10 : 1, r = P * 2, s = i.units === "mm" ? 1 : LA, v = 0.5, c = 4, n = 0.1, T = 5, z = i.theme.colors.axes.x, a = i.theme.colors.axes.y, o = { opacity: v, size: c };
  for (let w = P; ; w += r) {
    const E = w * s;
    if (E > B + 1e-6)
      break;
...
var zQ = {
  ...
  overwrite: !1,
  delay: 0
}, dB, q, y, hQ = 1e8, m = 1 / hQ, vB = Math.PI * 2, oP = vB / 4, TP = 0, HA = Math.sqrt, zP = Math.cos, aP = Math.sin, Z = function(Q) {
...
}, $ = Array.isArray, wP = /random\([^)]+\)/g, EP = /,\s*/g, BA = /(?:-?\.?\d|\.)+/gi, FA = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, qQ = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Xt = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, fA = /[+-]=-?[.\d]+/, hP = /[^,'"\[\]\s]+/gi, lP = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, Y, kQ, cB, OB, aQ = {}, ft = {}, GA, bA = function(Q) {
  ...
  suppressEvents: !0
}, MB = {}, fQ = [], nB = {}, gA, cQ = {}, Kt = {}, AA = 30, Ht = [], HB = "", jB = function(Q) {
  var t = Q[0], B, A;
  ...
  for (A = Q.length; A--; )
    Q[A] && (Q[A]._gsap || (Q[A]._gsap = new Pe(Q[A], B))) || Q.splice(A, 1);
  return Q;
}, YQ = function(Q) {
  return Q._gsap || jB(lQ(Q))[0]._gsap;
}, mA = function(Q, t, B) {
  return (B = Q[t]) && J(B) ? Q[t]() : CB(B) && Q.getAttribute && Q.getAttribute(t) || B;
}, eQ = function(Q, t) {
  ...
  for (nB = {}, fQ.length = 0, B = 0; B < Q; B++)
    A = t[B], A && A._lazy && (A.render(A._lazy[0], A._lazy[1], !0)._lazy = 0);
}, FB = function(Q) {
  return !!(Q._initted || Q._startAt || Q.add);
}, xA = function(Q, t, B, A) {
  fQ.length && !q && Gt(), Q.render(t, B, !!(q && t < 0 && FB(Q))), fQ.length && !q && Gt();
}, yA = function(Q) {
  var t = parseFloat(Q);
  return (t || t === 0) && (Q + "").match(hP).length < 2 ? t : Z(Q) ? Q.trim() : Q;
}, IA = function(Q) {
  return Q;
}, wQ = function(Q, t) {
  for (var B in t)
  ...
  var t = Q.parent || Y, B = Q.keyframes ? DP($(Q.keyframes)) : wQ;
  if (AQ(Q.inherit))
    for (; t; )
  ...
  var B = Math.floor(Q = S(Q / t));
  return Q && B === Q ? B - 1 : B;
}, pt = function(Q, t) {
  return (Q - t._start) * t._ts + (t._ts >= 0 ? 0 : t._dirty ? t.totalDuration() : t._tDur);
}, It = function(Q) {
  return Q._end = S(Q._start + (Q._tDur / Math.abs(Q._ts || Q._rts || m) || 0));
}, St = function(Q, t) {
  var B = Q._dp;
  return B && B.smoothChildTiming && Q._ts && (Q._start = S(B._time - (Q._ts > 0 ? t / Q._ts : ((Q._dirty ? Q.totalDuration() : Q._tDur) - t) / -Q._ts)), It(Q), B._dirty || VQ(B, Q)), Q;
}, YA = function(Q, t) {
  var B;
  ...
  return t.parent && bQ(t), t._start = S((NQ(B) ? B : B || Q !== Y ? EQ(Q, B, t) : Q._time) + t._delay), t._end = S(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), SA(Q, t, "_first", "_last", Q._sort ? "_start" : 0), TB(t) || (Q._recent = t), A || YA(Q, t), Q._ts < 0 && St(Q, Q._tTime), Q;
}, VA = function(Q, t) {
  return (aQ.ScrollTrigger || LB("scrollTrigger", t)) && aQ.ScrollTrigger.create(t, Q);
}, JA = function(Q, t, B, A, e) {
  if (GB(Q, t, e), !Q._initted)
    return 1;
  if (!B && Q._pt && !q && (Q._dur && Q.vars.lazy !== !1 || !Q._dur && Q.vars.lazy) && gA !== nQ.frame)
  ...
  var e = Q.ratio, P = t < 0 || !t && (!Q._start && OP(Q) && !(!Q._initted && TB(Q)) || (Q._ts < 0 || Q._dp._ts < 0) && !TB(Q)) ? 0 : 1, r = Q._rDelay, s = 0, v, c, n;
  if (r && Q._repeat && (s = dt(0, Q._tDur, t), c = At(s, r), Q._yoyo && c & 1 && (P = 1 - P), c !== At(Q._tTime, r) && (e = 1 - P, Q.vars.repeatRefresh && Q._initted && Q.invalidate())), P !== e || q || A || Q._zTime === m || !t && Q._zTime) {
    if (!Q._initted && JA(Q, t, A, B, s))
      return;
    for (n = Q._zTime, Q._zTime = t || (B ? m : 0), B || (B = t && !n), Q.ratio = P, Q._from && (P = 1 - P), Q._time = 0, Q._tTime = s, v = Q._pt; v; )
      v.r(P, v.d), v = v._next;
    t < 0 && oB(Q, t, B, !0), Q._onUpdate && !B && oQ(Q, "onUpdate"), s && Q._repeat && !B && Q.parent && oQ(Q, "onRepeat"), (t >= Q._tDur || t < 0) && Q.ratio === P && (P && bQ(Q, 1), !B && !q && (oQ(Q, P ? "onComplete" : "onReverseComplete", !0), Q._prom && Q._prom()));
  ...
  var e = Q._repeat, P = S(t) || 0, r = Q._tTime / Q._tDur;
  return r && !A && (Q._time *= P / Q._dur), Q._dur = P, Q._tDur = e ? e < 0 ? 1e10 : S(P * (e + 1) + Q._rDelay * e) : P, r > 0 && !A && St(Q, Q._tTime = Q._tDur * r), Q.parent && It(Q), B || VQ(Q.parent, Q), Q;
}, iA = function(Q) {
  ...
  var A = Q.labels, e = Q._recent || HP, P = Q.duration() >= hQ ? e.endTime(!1) : Q._dur, r, s, v;
  ...
  return !Z(Q) || !(t = lP.exec(Q)) ? "" : t[1];
}, jP = function(Q, t, B) {
  return mQ(B, function(A) {
    return dt(Q, t, A);
  });
}, zB = [].slice, RA = function(Q, t) {
  return Q && DQ(Q) && "length" in Q && (!t && !Q.length || Q.length - 1 in Q && DQ(Q[0])) && !Q.nodeType && Q !== kQ;
}, FP = function(Q, t, B) {
  return B === void 0 && (B = []), Q.forEach(function(A) {
    var e;
    return Z(A) && !t || RA(A, 1) ? (e = B).push.apply(e, lQ(A)) : B.push(A);
  }) || B;
}, lQ = function(Q, t, B) {
  return y && !t && y.selector ? y.selector(Q) : Z(Q) && !B && (cB || !Pt()) ? zB.call((t || OB).querySelectorAll(Q), 0) : $(Q) ? FP(Q, B) : RA(Q) ? zB.call(Q, 0) : Q ? [Q] : [];
}, aB = function(Q) {
  return Q = lQ(Q)[0] || Et("Invalid scope") || {}, function(t) {
    var B = Q.current || Q.nativeElement || Q;
    return lQ(t, B.querySelectorAll ? B : B === Q ? Et("Invalid scope") || OB.createElement("div") : Q);
  };
}, XA = function(Q) {
  ...
  return Z(A) ? c = n = {
    ...
    if (!w) {
      ...
      A === "random" && XA(w), w.max = D - N, w.min = N, w.v = o = (parseFloat(t.amount) || parseFloat(t.each) * (d > o ? o - 1 : v ? v === "y" ? o / d : d : Math.max(d, o / d)) || 0) * (A === "edges" ? -1 : 1), w.b = o < 0 ? e - o : e, w.u = _(t.amount || t.each) || 0, B = B && o < 0 ? JP(B) : B;
    }
    return o = (w[T] - w.min) / w.max || 0, S(w.b + (B ? B(o) : o) * w.v) + w.u;
  };
}, wB = function(Q) {
  var t = Math.pow(10, ((Q + "").split(".")[1] || "").length);
  return function(B) {
    var A = S(Math.round(parseFloat(B) / Q) * Q * t);
    return (A - A % 1) / t + (NQ(B) ? 0 : _(B));
  };
}, ZA = function(Q, t) {
  var B = $(Q), A, e;
  return !B && DQ(Q) && (A = B = Q.radius || hQ, Q.values ? (Q = lQ(Q.values), (e = !NQ(Q[0])) && (A *= A)) : Q = wB(Q.increment)), mQ(t, B ? J(Q) ? function(P) {
  ...
  var A = t - Q;
  return $(Q) ? qA(Q, i(0, Q.length), t) : mQ(B, function(e) {
    return (A + (e - Q) % A) % A + Q;
  });
}, gP = function i(Q, t, B) {
  var A = t - Q, e = A * 2;
  return $(Q) ? qA(Q, i(0, Q.length - 1), t) : mQ(B, function(P) {
    return P = (e + (P - Q) % e) % e || 0, Q + (P > A ? e - P : P);
  });
}, lt = function(Q) {
  return Q.replace(wP, function(t) {
    var B = t.indexOf("[") + 1, A = t.substring(B || 7, B ? t.indexOf("]") : t.length - 1).split(EP);
    return WA(B ? A : +A[0], B ? 0 : +A[1], +A[2] || 1e-5);
  });
}, _A = function(Q, t, B, A, e) {
  var P = t - Q, r = A - B;
  return mQ(e, function(s) {
    return B + ((s - Q) / P * r || 0);
  });
}, mP = function i(Q, t, B, A) {
  ...
  if (!e) {
    ...
    if (!c) {
      for (s in t)
        fB.call(r, Q, s, "get", t[s]);
      e = function(a) {
        return gB(a, r) || (P ? Q.p : Q);
      };
    }
  }
  return mQ(B, e);
  ...
  if (Q)
    if (Q = !Q.name && Q.default || Q, NB() || Q.headless) {
      ...
      if (Pt(), Q !== A) {
        if (cQ[t])
          return;
        wQ(A, wQ(bt(Q, e), P)), Bt(A.prototype, Bt(e, bt(Q, P))), cQ[A.prop = t] = A, Q.targetTest && (Ht.push(A), MB[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
      }
      pA(t, A), Q.register && Q.register(rQ, A, PQ);
    } else
      $A.push(Q);
}, g = 255, ot = {
  aqua: [0, g, g],
  ...
  if (!A) {
    if (Q.substr(-1) === "," && (Q = Q.substr(0, Q.length - 1)), ot[Q])
      ...
      if (A = a = Q.match(BA), !t)
        s = +A[0] % 360 / 360, v = +A[1] / 100, c = +A[2] / 100, P = c <= 0.5 ? c * (v + 1) : c + v - c * v, e = c * 2 - P, A.length > 3 && (A[3] *= 1), A[0] = Zt(s + 1 / 3, e, P), A[1] = Zt(s, e, P), A[2] = Zt(s - 1 / 3, e, P);
      else if (~Q.indexOf("="))
        return A = Q.match(FA), B && A.length < 4 && (A[3] = 1), A;
    } else
      A = Q.match(BA) || ot.transparent;
    A = A.map(Number);
  }
  ...
  if (e = e.map(function(T) {
    return (T = te(T, t, 1)) && P + (t ? T[0] + "," + T[1] + "%," + T[2] + "%," + T[3] : T.join(",")) + ")";
  }), B && (c = Be(Q), s = B.c, s.join(A) !== c.c.join(A)))
...
}(), xP = /hsl[a]?\(/, Ae = function(Q) {
  var t = Q.join(" "), B;
  if (GQ.lastIndex = 0, GQ.test(t))
    return B = xP.test(t), Q[1] = sA(Q[1], B), Q[0] = sA(Q[0], B, Be(Q[1])), !0;
}, kt, nQ = function() {
  ...
  return n = {
    ...
    wake: function() {
      GA && (!cB && NB() && (kQ = cB = window, OB = kQ.document || {}, aQ.gsap = rQ, (kQ.gsapVersions || (kQ.gsapVersions = [])).push(rQ.version), bA(ft || kQ.GreenSockGlobals || !kQ.gsap && kQ || {}), $A.forEach(Qe)), c = typeof requestAnimationFrame < "u" && requestAnimationFrame, s && n.sleep(), v = c || function(w) {
  ...
  return !kt && nQ.wake();
}, p = {}, yP = /^[\d.\-M][\d.\-,\s]/, IP = /["']/g, SP = function(Q) {
  for (var t = {}, B = Q.substr(1, Q.length - 3).split(":"), A = B[0], e = 1, P = B.length, r, s, v; e < P; e++)
    s = B[e], r = e !== P - 1 ? s.lastIndexOf(",") : s.length, v = s.substr(0, r), t[A] = isNaN(v) ? v.replace(IP, "").trim() : +v, A = s.substr(r + 1).trim();
  return t;
}, YP = function(Q) {
  ...
  return B && t.length > 1 && B.config ? B.config.apply(null, ~Q.indexOf("{") ? [SP(t[1])] : YP(Q).split(",").map(yA)) : p._CE && yP.test(Q) ? p._CE("", Q) : B;
}, JP = function(Q) {
  return function(t) {
    return 1 - Q(1 - t);
  };
}, JQ = function(Q, t) {
  return Q && (J(Q) ? Q : p[Q] || VP(Q)) || t;
}, XQ = function(Q, t, B, A) {
  ...
  var A = t >= 1 ? t : 1, e = (B || (Q ? 0.3 : 0.45)) / (t < 1 ? t : 1), P = e / vB * (Math.asin(1 / A) || 0), r = function(c) {
    return c === 1 ? 1 : A * Math.pow(2, -10 * c) * aP((c - P) * e) + 1;
...
XQ("Sine", function(i) {
  return i === 1 ? 1 : -zP(i * oP) + 1;
});
XQ("Back", qt("in"), qt("out"), qt());
...
eQ("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt", function(i) {
  return HB += i + "," + i + "Params,";
});
var Pe = function(Q, t) {
  this.id = TP++, Q._gsap = this, this.target = Q, this.harness = t, this.get = t ? t.get : mA, this.set = t ? t.getSetter : pB;
  ...
  return Q.delay = function(B) {
    ...
    if (e && e.smoothChildTiming && this._ts) {
      for (St(this, B), !e._dp || e.parent || YA(e, this); e && e.parent; )
    ...
    return arguments.length ? this.totalTime(Math.min(this.totalDuration(), B + PA(this)) % (this._dur + this._rDelay) || (B ? this._dur : 0), A) : this._time;
    ...
    return arguments.length ? this.totalTime(this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - B : B) + PA(this), A) : this.duration() ? Math.min(1, this._time / this._dur) : this.rawTime() > 0 ? 1 : 0;
    ...
    return this._rts = +B || 0, this._ts = this._ps || B === -m ? 0 : this._rts, this.totalTime(dt(-Math.abs(this._delay), this.totalDuration(), e), A !== !1), It(this), CP(this);
  }, Q.paused = function(B) {
...
var BQ = /* @__PURE__ */ function(i) {
  ...
  function Q(B, A) {
    var e;
    return B === void 0 && (B = {}), e = i.call(this, B) || this, e.labels = {}, e.smoothChildTiming = !!B.smoothChildTiming, e.autoRemoveChildren = !!B.autoRemoveChildren, e._sort = AQ(B.sortChildren), Y && uQ(B.parent || Y, dQ(e), A), B.reversed && e.reverse(), B.paused && e.paused(!0), B.scrollTrigger && VA(dQ(e), B.scrollTrigger), e;
  }
  var t = Q.prototype;
  return t.to = function(A, e, P) {
    ...
    var r = this._time, s = this._dirty ? this.totalDuration() : this._tDur, v = this._dur, c = A <= 0 ? 0 : S(A), n = this._zTime < 0 != A < 0 && (this._initted || !v), T, z, a, o, w, E, h, u, U, k, O, D;
    if (this !== Y && c > s && A >= 0 && (c = s), c !== this._tTime || P || n) {
      if (r !== this._time && v && (c += this._time - r, A += this._time - r), T = c, U = this._start, u = this._ts, E = !u, n && (v || (r = this._zTime), (A || !e) && (this._zTime = A)), this._repeat) {
        ...
        if (T = S(c % w), c === s ? (o = this._repeat, T = v) : (k = S(c / w), o = ~~k, o && o === k && (T = v, o--), T > v && (T = v)), k = At(this._tTime, w), !r && this._tTime && k !== o && this._tTime - k * w - this._dur <= 0 && (k = o), O && o & 1 && (T = v - T, D = 1), o !== k && !this._lock) {
          var N = O && k & 1, d = N === (O && o & 1);
          if (o < k && (N = !N), r = N ? 0 : c % v ? v : c, this._lock = 1, this.render(r || (D ? 0 : S(o * w)), e, !v)._lock = 0, this._tTime = c, !e && this.parent && oQ(this, "onRepeat"), this.vars.repeatRefresh && !D && (this.invalidate()._lock = 1, k = o), r && r !== this._time || E !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (h = MP(this, S(r), S(T)), h && (c -= T - (T = h._start))), this._tTime = c, this._time = T, this._act = !!u, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = A, r = 0), !r && c && v && !e && !k && (oQ(this, "onStart"), this._tTime !== c))
        return this;
      if (T >= r && A >= 0)
        for (z = this._first; z; ) {
        ...
        for (var M = A < 0 ? A : T; z; ) {
          if (a = z._prev, (z._act || M <= z._end) && z._ts && h !== z) {
            if (z.parent !== this)
              return this.render(A, e, P);
            if (z.render(z._ts > 0 ? (M - z._start) * z._ts : (z._dirty ? z.totalDuration() : z._tDur) + (M - z._start) * z._ts, e, P || q && FB(z)), T !== this._time || !this._ts && !E) {
      ...
      if (h && !e && (this.pause(), h.render(T >= r ? 0 : -m)._zTime = T >= r ? 1 : -1, this._ts))
        return this._start = U, It(this), this.render(A, e, P);
    ...
    return Z(A) ? this.removeLabel(A) : J(A) ? this.killTweensOf(A) : (A.parent === this && yt(this, A), A === this._recent && (this._recent = this._last), VQ(this));
  }, t.totalTime = function(A, e) {
    return arguments.length ? (this._forcing = 1, !this._dp && this._ts && (this._start = S(nQ.time - (this._ts > 0 ? A / this._ts : (this.totalDuration() - A) / -this._ts))), i.prototype.totalTime.call(this, A, e), this._forcing = 0, this) : this._tTime;
    ...
    for (var P = [], r = lQ(A), s = this._first, v = NQ(e), c; s; )
      s instanceof K ? UP(s._targets, r) && (v ? (!HQ || s._initted && s._ts) && s.globalTime(0) <= e && s.globalTime(s.totalDuration()) > e : !e || s.isActive()) && P.push(s) : (c = s.getTweensOf(r, e)).length && P.push.apply(P, c), s = s._next;
    return P;
    ...
    return A === void 0 && (A = this._time), rA(this, EQ(this, A));
  }, t.previousLabel = function(A) {
    return A === void 0 && (A = this._time), rA(this, EQ(this, A), 1);
    ...
    if (P._dirty) {
      for (n = P.parent; r; )
        v = r._prev, r._dirty && r.totalDuration(), c = r._start, c > s && P._sort && r._ts && !P._lock ? (P._lock = 1, uQ(P, r, c - r._delay, 1)._lock = 0) : s = c, c < 0 && r._ts && (e -= c, (!n && !P._dp || n && n.smoothChildTiming) && (P._start += S(c / P._ts), P._time -= c, P._tTime -= c), P.shiftChildren(-c, !1, -1 / 0), s = 0), r._end > e && r._ts && (e = r._end), r = v;
      et(P, P === Y && P._time > e ? P._time : e, 1, 1), P._dirty = 0;
    }
    return P._tDur;
  }, Q.updateRoot = function(A) {
    if (Y._ts && (xA(Y, pt(A, Y)), gA = nQ.frame), nQ.frame >= AA) {
      AA += zQ.autoSleep || 120;
      var e = Y._first;
...
var RP = function(Q, t, B, A, e, P, r) {
  var s = new PQ(this._pt, Q, t, 0, 1, ne, null, e), v = 0, c = 0, n, T, z, a, o, w, E, h;
  for (s.b = B, s.e = A, B += "", A += "", (E = ~A.indexOf("random(")) && (A = lt(A)), P && (h = [B, A], P(h, Q, t), B = h[0], A = h[1]), T = B.match(Xt) || []; n = Xt.exec(A); )
...
}, fB = function(Q, t, B, A, e, P, r, s, v, c) {
  J(A) && (A = A(e || 0, Q, P));
  var n = Q[t], T = B !== "get" ? B : J(n) ? v ? Q[t.indexOf("set") || !J(Q["get" + t.substr(3)]) ? t : "get" + t.substr(3)](v) : Q[t]() : n, z = J(n) ? v ? qP : ve : bB, a;
  if (Z(A) && (~A.indexOf("random(") && (A = lt(A)), A.charAt(1) === "=" && (a = $Q(T, A) + (_(T) || 0), (a || a === 0) && (A = a))), !c || T !== A || EB)
    return !isNaN(T * A) && A !== "" ? (a = new PQ(this._pt, Q, t, +T || 0, A - (T || 0), typeof n == "boolean" ? $P : ce, 0, z), v && (a.fp = v), r && a.modifier(r, this, Q), this._pt = a) : (!n && !(t in Q) && LB(t, A), RP.call(this, Q, t, T, A, z, s || zQ.stringFilter, v));
}, XP = function(Q, t, B, A, e) {
  if (J(Q) && (Q = at(Q, e, t, B, A)), !DQ(Q) || Q.style && Q.nodeType || $(Q) || jA(Q))
    return Z(Q) ? at(Q, e, t, B, A) : Q;
  var P = {}, r;
  for (r in Q)
    P[r] = at(Q[r], e, t, B, A);
  return P;
}, ie = function(Q, t, B, A, e, P) {
  var r, s, v, c;
  if (cQ[Q] && (r = new cQ[Q]()).init(e, r.rawVars ? t[Q] : XP(t[Q], A, e, P, B), B, A, P) !== !1 && (B._pt = s = new PQ(B._pt, e, Q, 0, 1, r.render, r, 0, r.priority), B !== _Q))
    for (v = B._ptLookup[B._targets.indexOf(e)], c = r._props.length; c--; )
      v[r._props[c]] = s;
  return r;
}, HQ, EB, GB = function i(Q, t, B) {
  var A = Q.vars, e = A.ease, P = A.startAt, r = A.immediateRender, s = A.lazy, v = A.onUpdate, c = A.runBackwards, n = A.yoyoEase, T = A.keyframes, z = A.autoRevert, a = Q._dur, o = Q._startAt, w = Q._targets, E = Q.parent, h = E && E.data === "nested" ? E.vars.targets : w, u = Q._overwrite === "auto" && !dB, U = Q.timeline, k = A.easeReverse || n, O, D, N, d, M, b, G, C, j, F, H, f, I;
  if (U && (!T || !e) && (e = "none"), Q._ease = JQ(e, wt.ease), Q._rEase = k && (JQ(k) || Q._ease), Q._from = !U && !!A.runBackwards, Q._from && (Q.ratio = 1), !U || T && !A.stagger) {
    if (C = w[0] ? YQ(w[0]).harness : 0, f = C && A[C.prop], O = bt(A, MB), o && (o._zTime < 0 && o.progress(1), t < 0 && c && r && !z ? o.render(-1, !0) : o.revert(c && a ? Mt : kP), o._lazy = 0), P) {
    ...
    for (Q._pt = Q._ptCache = 0, s = a && AQ(s) || s && !a, D = 0; D < w.length; D++) {
      if (M = w[D], G = M._gsap || jB(w)[D]._gsap, Q._ptLookup[D] = F = {}, nB[G.id] && fQ.length && Gt(), H = h === w ? D : h.indexOf(M), C && (j = new C()).init(M, f || O, Q, H, h) !== !1 && (Q._pt = d = new PQ(Q._pt, M, j.name, 0, 1, j.render, j, 0, j.priority), j._props.forEach(function(R) {
        F[R] = d;
      }), j.priority && (b = 1)), !C || f)
        for (N in O)
          cQ[N] && (j = ie(N, O, Q, H, M, h)) ? j.priority && (b = 1) : F[N] = d = fB.call(Q, M, N, "get", O[N], H, h, 0, A.stringFilter);
      Q._op && Q._op[D] && Q.kill(M, Q._op[D]), u && Q._pt && (HQ = Q, Y.killTweensOf(M, F, Q.globalTime(t)), I = !Q.parent, HQ = 0), Q._pt && s && (nB[G.id] = 1);
    }
    b && oe(Q), Q._onInit && Q._onInit(Q);
  }
  Q._onUpdate = v, Q._initted = (!Q._op || Q._pt) && !I, T && t <= 0 && U.render(hQ, !0, !0);
}, KP = function(Q, t, B, A, e, P, r, s) {
    ...
    for (v = Q._ptCache[t] = [], T = Q._ptLookup, z = Q._targets.length; z--; ) {
      if (c = T[z][t], c && c.d && c.d._pt)
        for (c = c.d._pt; c && c.p !== t && c.fp !== t; )
          c = c._next;
      if (!c)
        return EB = 1, Q.vars[t] = "+=0", GB(Q, r), EB = 0, s ? Et(t + " not eligible for reset. Try splitting into individual properties") : 1;
      v.push(c);
    }
  for (z = v.length; z--; )
    n = v[z], c = n._pt || n, c.s = (A || A === 0) && !e ? A : c.s + (A || 0) + P * c.c, c.c = B - c.s, n.e && (n.e = X(B) + _(n.e)), n.b && (n.b = c.s + _(n.b));
}, ZP = function(Q, t) {
  var B = Q[0] ? YQ(Q[0]).harness : 0, A = B && B.aliases, e, P, r, s;
  if (!A)
    return t;
  e = Bt({}, t);
  for (P in A)
...
eQ(re + ",id,stagger,delay,duration,paused,scrollTrigger", function(i) {
  return se[i] = 1;
});
var K = /* @__PURE__ */ function(i) {
  ...
  function Q(B, A, e, P) {
    ...
    var s = r.vars, v = s.duration, c = s.delay, n = s.immediateRender, T = s.stagger, z = s.overwrite, a = s.keyframes, o = s.defaults, w = s.scrollTrigger, E = A.parent || Y, h = ($(B) || jA(B) ? NQ(B[0]) : "length" in A) ? [B] : lQ(B), u, U, k, O, D, N, d, M;
    if (r._targets = h.length ? jB(h) : Et("GSAP target " + B + " not found. https://gsap.com", !zQ.nullTargetWarn) || [], r._ptLookup = [], r._overwrite = z, a || T || Lt(v) || Lt(c)) {
      A = r.vars;
      ...
      if (u = r.timeline = new BQ({
        ...
        if (O = h.length, d = T && KA(T), DQ(T))
          for (D in T)
            ~re.indexOf(D) && (M || (M = {}), M[D] = T[D]);
        for (U = 0; U < O; U++)
          k = bt(A, se), k.stagger = 0, b && (k.easeReverse = b), M && Bt(k, M), N = h[U], k.duration = +at(v, dQ(r), U, N, h), k.delay = (+at(c, dQ(r), U, N, h) || 0) - r._delay, !T && O === 1 && k.delay && (r._delay = c = k.delay, r._start += c, k.delay = 0), u.to(N, k, d ? d(U, N, h) : 0), u._ease = p.none;
        ...
        if ($(a))
          ...
          k = {};
          for (D in a)
            D === "ease" || D === "easeEach" || WP(D, a[D], k, a.easeEach);
          for (D in k)
      ...
      r.timeline = 0;
    return z === !0 && !dB && (HQ = dQ(r), Y.killTweensOf(h), HQ = 0), uQ(E, dQ(r), e), A.reversed && r.reverse(), A.paused && r.paused(!0), (n || !v && !a && r._start === S(E._time) && AQ(n) && NP(dQ(r)) && E.data !== "nested") && (r._tTime = -m, r.render(Math.max(0, -c) || 0)), w && VA(dQ(r), w), r;
  }
  var t = Q.prototype;
  return t.render = function(A, e, P) {
    ...
    if (!v)
      ...
      if (T = n, u = this.timeline, this._repeat) {
        ...
        if (T = S(n % o), n === s ? (a = this._repeat, T = v) : (w = S(n / o), a = ~~w, a && a === w ? (T = v, a--) : T > v && (T = v)), E = this._yoyo && a & 1, E && (T = v - T), w = At(this._tTime, o), T === r && !P && this._initted && a === w)
          return this._tTime = n, this;
        a !== w && this.vars.repeatRefresh && !E && !this._lock && T !== o && this._initted && (this._lock = P = 1, this.render(S(o * a), !0).invalidate()._lock = 0);
      }
      if (!this._initted) {
        if (JA(this, c ? A : T, P, e, n))
      ...
      for (z = this._pt; z; )
        z.r(h, z.d), z = z._next;
      u && u.render(A < 0 ? A : u._dur * u._ease(T / this._dur), e, P) || this._startAt && (this._zTime = A), this._onUpdate && !e && (c && oB(this, A, e, P), oQ(this, "onUpdate")), this._repeat && a !== w && this.vars.onRepeat && !e && this.parent && oQ(this, "onRepeat"), (n === this._tDur || !n) && this._tTime === n && (c && !this._onUpdate && oB(this, A, !0, !0), (A || !v) && (n === this._tDur && this._ts > 0 || !n && this._ts < 0) && bQ(this, 1), !e && !(c && !r) && (n || r || E) && (oQ(this, n === s ? "onComplete" : "onReverseComplete", !0), this._prom && !(n < s && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, t.targets = function() {
    ...
    return this._initted || GB(this, v), c = this._ease(v / this._dur), KP(this, A, e, P, r, c, v, s) ? this.resetTo(A, e, P, r, 1) : (St(this, 0), this.parent || SA(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(A, e) {
    ...
    for (n = this._op = this._op || [], e !== "all" && (Z(e) && (o = {}, eQ(e, function(h) {
      return o[h] = 1;
    }), e = o), e = ZP(r, e)), E = r.length; E--; )
      if (~s.indexOf(r[E])) {
        T = v[E], e === "all" ? (n[E] = e, a = T, z = {}) : (z = n[E] = n[E] || {}, a = e);
        for (o in a)
          w = T && T[o], w && ((!("kill" in w.d) || w.d.kill(o) === !0) && yt(this, w, "_pt"), delete T[o]), z !== "all" && (z[o] = 1);
      }
...
eQ("staggerTo,staggerFrom,staggerFromTo", function(i) {
  K[i] = function() {
    var Q = new BQ(), t = zB.call(arguments, 0);
    return t.splice(i === "staggerFromTo" ? 5 : 4, 0, 0), Q[i].apply(Q, t);
  };
});
var bB = function(Q, t, B) {
  return Q[t] = B;
}, ve = function(Q, t, B) {
  return Q[t](B);
}, qP = function(Q, t, B, A) {
  ...
  return J(Q[t]) ? ve : CB(Q[t]) && Q.setAttribute ? _P : bB;
}, ce = function(Q, t) {
  ...
  for (var t = this._pt, B, A; t; )
    A = t._next, t.p === Q && !t.op || t.op === Q ? yt(this, t, "_pt") : t.dep || (B = 1), t = A;
  return !B;
}, Bi = function(Q, t, B, A) {
  ...
  function i(t, B, A, e, P, r, s, v, c) {
    this.t = B, this.s = e, this.c = P, this.p = A, this.r = r || ce, this.d = s || this, this.set = v || bB, this.pr = c || 0, this._next = t, t && (t._prev = this);
  }
  var Q = i.prototype;
  return Q.modifier = function(B, A, e) {
    this.mSet = this.mSet || this.set, this.set = Bi, this.m = B, this.mt = e, this.tween = A;
  }, i;
}();
eQ(HB + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger,easeReverse", function(i) {
  return MB[i] = 1;
});
...
zQ.stringFilter = Ae;
var RQ = [], jt = {}, Ai = [], vA = 0, ei = 0, _t = function(Q) {
  return (jt[Q] || Ai).map(function(t) {
    return t();
  });
}, hB = function() {
  var Q = Date.now(), t = [];
  Q - vA > 2 && (_t("matchMediaInit"), RQ.forEach(function(B) {
    var A = B.queries, e = B.conditions, P, r, s, v;
    for (r in A)
      P = kQ.matchMedia(A[r]).matches, P && (s = 1), P !== e[r] && (e[r] = P, v = 1);
    v && (B.revert(), s && t.push(B));
  }), _t("matchMediaRevert"), t.forEach(function(B) {
  ...
  function i(t, B) {
    this.selector = B && aB(B), this.data = [], this._r = [], this.isReverted = !1, this.id = ei++, t && this.add(t);
  }
  var Q = i.prototype;
  return Q.add = function(B, A, e) {
    ...
    var P = this, r = function() {
      ...
      return v && v !== P && v.data.push(P), e && (P.selector = aB(e)), y = P, n = A.apply(P, arguments), J(n) && P._r.push(n), y = v, P.selector = c, P.isReverted = !1, n;
    };
  ...
  return Q.add = function(B, A, e) {
    ...
    var P = new Te(0, e || this.scope), r = P.conditions = {}, s, v, c;
    y && !P.selector && (P.selector = y.selector), this.contexts.push(P), A = P.add("onMatch", A), P.queries = B;
    for (v in B)
      v === "all" ? c = 1 : (s = kQ.matchMedia(B[v]), s && (RQ.indexOf(P) < 0 && RQ.push(P), (r[v] = s.matches) && (c = 1), s.addListener ? s.addListener(hB) : s.addEventListener("change", hB)));
  ...
  getTweensOf: function(Q, t) {
    return Y.getTweensOf(Q, t);
  },
  getProperty: function(Q, t, B, A) {
    Z(Q) && (Q = lQ(Q)[0]);
    var e = YQ(Q || {}).get, P = B ? IA : yA;
  ...
  quickSetter: function(Q, t, B) {
    ...
    Q = Q[0] || {};
    var P = cQ[t], r = YQ(Q), s = r.harness && (r.harness.aliases || {})[t] || t, v = P ? function(c) {
      var n = new P();
      _Q._pt = 0, n.init(Q, B ? c + B : c, _Q, 0, [Q]), n.render(1, n), _Q._pt && gB(1, _Q);
    } : r.set(Q, s);
  ...
  defaults: function(Q) {
    return Q && Q.ease && (Q.ease = JQ(Q.ease, wt.ease)), eA(wt, Q || {});
  },
  config: function(Q) {
    return eA(zQ, Q || {});
  },
  registerEffect: function(Q) {
    ...
    (A || "").split(",").forEach(function(r) {
      ...
      return this.add(Kt[t](r, DQ(s) ? s : (v = s) && {}, this), v);
    });
  },
  ...
  exportRoot: function(Q, t) {
    Q === void 0 && (Q = {});
    var B = new BQ(Q), A, e;
    for (B.smoothChildTiming = AQ(Q.smoothChildTiming), Y.remove(B), B._dp = 0, B._time = B._tTime = Y._time, A = Y._first; A; )
      e = A._next, (t || !(!A._dur && A instanceof K && A.vars.onComplete === A._targets[0])) && uQ(B, A, A._start - A._delay), A = e;
    return uQ(Y, B, 0), B;
  },
  context: function(Q, t) {
    return Q ? new Te(Q, t) : y;
  },
...
var ii = function(Q, t) {
  ...
  for (A in t)
    for (e = B.length; e--; )
      P = Q._ptLookup[e][A], P && (P = P.d) && (P._pt && (P = ii(P, A)), P && P.modifier && P.modifier(t[A], Q, B[e], A));
}, $t = function(Q, t) {
  return {
    name: Q,
    headless: 1,
...
}, $t("roundProps", wB), $t("modifiers"), $t("snap", ZA)) || gt;
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var cA, jQ, Qt, mB, SQ, nA, xB, si = function() {
  return typeof window < "u";
}, OQ = {}, IQ = 180 / Math.PI, tt = Math.PI / 180, KQ = Math.atan2, oA = 1e8, yB = /([A-Z])/g, vi = /(left|right|width|margin|padding|x)/i, ci = /[\s,\(]\S/, UQ = {
  ...
  if (this.tfm) {
    for (P in this.tfm)
      A[P] = this.tfm[P];
    A.svg && (A.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), e = xB(), (!e || !e.isStart) && !B[V] && (we(B), A.zOrigin && B[iQ] && (B[iQ] += " " + A.zOrigin + "px", A.zOrigin = 0, A.renderTransform()), A.uncache = 1);
  }
}, Ee = function(Q, t) {
  var B = {
    target: Q,
...
}, TA = "O,Moz,ms,Ms,Webkit".split(","), it = function(Q, t, B) {
  var A = t || SQ, e = A.style, P = 5;
  if (Q in e && !B)
    return Q;
  for (Q = Q.charAt(0).toUpperCase() + Q.substr(1); P-- && !(TA[P] + Q in e); )
    ;
  return P < 0 ? null : (P === 3 ? "ms" : P >= 0 ? TA[P] : "") + Q;
}, uB = function() {
  si() && window.document && (cA = window, jQ = cA.document, Qt = jQ.documentElement, SQ = kB("div") || {
    style: {}
  }, kB("div"), V = it(V), iQ = V + "Origin", SQ.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", he = !!it("perspective"), xB = rQ.core.reverting, mB = 1);
}, zA = function(Q) {
  var t = Q.ownerSVGElement, B = kB("svg", t && t.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), A = Q.cloneNode(!0), e;
  ...
  return t && (t.width || t.height) || B || (t = zA(Q)), t && !t.width && !t.x && !t.y ? {
    x: +aA(Q, ["x", "cx", "x1"]) || 0,
    y: +aA(Q, ["y", "cy", "y1"]) || 0,
    width: 0,
    height: 0
  ...
  return !!(Q.getCTM && (!Q.parentNode || Q.ownerSVGElement) && le(Q));
}, pQ = function(Q, t) {
  if (t) {
    var B = Q.style, A;
  ...
  var r = new PQ(Q._pt, t, B, 0, 1, P ? ae : ze);
  ...
  var e = parseFloat(B) || 0, P = (B + "").trim().substr((e + "").length) || "px", r = SQ.style, s = vi.test(t), v = Q.tagName.toLowerCase() === "svg", c = (v ? "client" : "offset") + (s ? "Width" : "Height"), n = 100, T = A === "px", z = A === "%", a, o, w, E;
  if (A === P || !e || wA[A] || wA[P])
    return e;
  if (P !== "px" && !T && (e = i(Q, t, B, "px")), E = Q.getCTM && ke(Q), (z || P === "%") && (OQ[t] || ~t.indexOf("adius")))
  ...
  if (z && (t === "height" || t === "width")) {
    ...
    (z || P === "%") && !Di[TQ(o, "display")] && (r.position = TQ(Q, "position")), o === Q && (r.position = "static"), o.appendChild(SQ), a = SQ[c], o.removeChild(SQ), r.position = "absolute";
  return s && z && (w = YQ(o), w.time = nQ.time, w.width = o[c]), X(T ? a * e / n : a && e ? n / a * e : 0);
}, CQ = function(Q, t, B, A) {
  var e;
  return mB || uB(), t in UQ && t !== "transform" && (t = UQ[t], ~t.indexOf(",") && (t = t.split(",")[0])), OQ[t] && t !== "transform" ? (e = Dt(Q, A), e = t !== "transformOrigin" ? e[t] : e.svg ? e.origin : xt(TQ(Q, iQ)) + " " + e.zOrigin + "px") : (e = Q.style[t], (!e || e === "auto" || A || ~(e + "").indexOf("calc(")) && (e = mt[t] && mt[t](Q, t, B) || TQ(Q, t) || mA(Q, t) || (t === "opacity" ? 1 : 0))), B && !~(e + "").trim().indexOf(" ") ? gQ(Q, t, e, B) + B : e;
}, di = function(Q, t, B, A) {
  if (!B || B === "none") {
    var e = it(t, Q, 1), P = e && TQ(Q, e, 1);
    P && P !== B ? (t = e, B = P) : t === "borderColor" && (B = TQ(Q, "borderTopColor"));
  }
  var r = new PQ(this._pt, Q.style, t, 0, 1, ne), s = 0, v = 0, c, n, T, z, a, o, w, E, h, u, U, k;
  if (r.b = B, r.e = A, B += "", A += "", A.substring(0, 6) === "var(--" && (A = TQ(Q, A.substring(4, A.indexOf(")")))), A === "auto" && (o = Q.style[t], Q.style[t] = A, A = TQ(Q, t) || A, o ? Q.style[t] = o : pQ(Q, t)), c = [B, A], Ae(c), B = c[0], A = c[1], T = B.match(qQ) || [], k = A.match(qQ) || [], k.length) {
    for (; n = qQ.exec(A); )
  ...
  return (B === "top" || B === "bottom" || A === "left" || A === "right") && (Q = B, B = A, A = Q), t[0] = EA[B] || B, t[1] = EA[A] || A, t.join(" ");
}, Ni = function(Q, t) {
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    s && (pQ(B, V), P && (P.svg && B.removeAttribute("transform"), A.scale = A.rotate = A.translate = "none", Dt(B, 1), P.uncache = 1, we(A)));
  }
}, mt = {
  clearProps: function(Q, t, B, A, e) {
    if (e.data !== "isFromStart") {
      var P = Q._pt = new PQ(Q._pt, t, B, 0, 0, Ni);
  ...
  */
  ...
  return c = n = T = o = w = E = h = u = U = 0, z = a = 1, B.svg = !!(Q.getCTM && ke(Q)), s.translate && ((s.translate !== "none" || s.scale !== "none" || s.rotate !== "none") && (A[V] = (s.translate !== "none" ? "translate3d(" + (s.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (s.rotate !== "none" ? "rotate(" + s.rotate + ") " : "") + (s.scale !== "none" ? "scale(" + s.scale.split(" ").join(",") + ") " : "") + (s[V] !== "none" ? s[V] : "")), A.scale = A.rotate = A.translate = "none"), D = IB(Q, B.svg), B.svg && (B.uncache ? (I = Q.getBBox(), v = B.xOrigin - I.x + "px " + (B.yOrigin - I.y) + "px", f = "") : f = !t && Q.getAttribute("data-svg-origin"), UB(Q, f || v, !!f || B.originIsAbsolute, B.smooth !== !1, D)), k = B.xOrigin || 0, O = B.yOrigin || 0, D !== Ut && (b = D[0], G = D[1], C = D[2], j = D[3], c = F = D[4], n = H = D[5], D.length === 6 ? (z = Math.sqrt(b * b + G * G), a = Math.sqrt(j * j + C * C), o = b || G ? KQ(G, b) * IQ : 0, h = C || j ? KQ(C, j) * IQ + o : 0, h && (a *= Math.abs(Math.cos(h * tt))), B.svg && (c -= k - (k * b + O * C), n -= O - (k * G + O * j))) : (vQ = D[6], x = D[7], QQ = D[8], sQ = D[9], W = D[10], tQ = D[11], c = D[12], n = D[13], T = D[14], N = KQ(vQ, W), w = N * IQ, N && (d = Math.cos(-N), M = Math.sin(-N), f = F * d + QQ * M, I = H * d + sQ * M, R = vQ * d + W * M, QQ = F * -M + QQ * d, sQ = H * -M + sQ * d, W = vQ * -M + W * d, tQ = x * -M + tQ * d, F = f, H = I, vQ = R), N = KQ(-C, W), E = N * IQ, N && (d = Math.cos(-N), M = Math.sin(-N), f = b * d - QQ * M, I = G * d - sQ * M, R = C * d - W * M, tQ = j * M + tQ * d, b = f, G = I, C = R), N = KQ(G, b), o = N * IQ, N && (d = Math.cos(N), M = Math.sin(N), f = b * d + G * M, I = F * d + H * M, G = G * d - b * M, H = H * d - F * M, b = f, F = I), w && Math.abs(w) + Math.abs(o) > 359.9 && (w = o = 0, E = 180 - E), z = X(Math.sqrt(b * b + G * G + C * C)), a = X(Math.sqrt(H * H + vQ * vQ)), N = KQ(F, H), h = Math.abs(N) > 2e-4 ? N * IQ : 0, U = tQ ? 1 / (tQ < 0 ? -tQ : tQ) : 0), B.svg && (f = Q.getAttribute("transform"), B.forceCSS = Q.setAttribute("transform", "") || !Ue(TQ(Q, V)), f && Q.setAttribute("transform", f))), Math.abs(h) > 90 && Math.abs(h) < 270 && (e ? (z *= -1, h += o <= 0 ? 180 : -180, o += o <= 0 ? 180 : -180) : (a *= -1, h += h <= 0 ? 180 : -180)), t = t || B.uncache, B.x = c - ((B.xPercent = c && (!t && B.xPercent || (Math.round(Q.offsetWidth / 2) === Math.round(-c) ? -50 : 0))) ? Q.offsetWidth * B.xPercent / 100 : 0) + P, B.y = n - ((B.yPercent = n && (!t && B.yPercent || (Math.round(Q.offsetHeight / 2) === Math.round(-n) ? -50 : 0))) ? Q.offsetHeight * B.yPercent / 100 : 0) + P, B.z = T + P, B.scaleX = X(z), B.scaleY = X(a), B.rotation = X(o) + r, B.rotationX = X(w) + r, B.rotationY = X(E) + r, B.skewX = h + r, B.skewY = u + r, B.transformPerspective = U + P, (B.zOrigin = parseFloat(v.split(" ")[2]) || !t && B.zOrigin || 0) && (A[iQ] = xt(v)), B.xOffset = B.yOffset = 0, B.force3D = zQ.force3D, B.renderTransform = B.svg ? Li : he ? De : Oi, B.uncache = 0, B;
}, xt = function(Q) {
  ...
  t.z = "0px", t.rotationY = t.rotationX = "0deg", t.force3D = 0, De(Q, t);
}, xQ = "0deg", st = "0px", yQ = ") ", De = function(Q, t) {
  ...
  if (u && (n !== xQ || c !== xQ)) {
    ...
    O = parseFloat(n) * tt, d = Math.cos(O), P = QB(h, P, D * d * -u), r = QB(h, r, -Math.sin(O) * -u), s = QB(h, s, N * d * -u + u);
  }
...
}, Mi = function(Q, t, B, A, e) {
  var P = 360, r = Z(e), s = parseFloat(e) * (r && ~e.indexOf("rad") ? IQ : 1), v = s - A, c = A + v + "deg", n, T;
  return r && (n = e.split("_")[1], n === "short" && (v %= P, v !== v % (P / 2) && (v += v < 0 ? P : -P)), n === "cw" && v < 0 ? v = (v + P * oA) % P - ~~(v / P) * P : n === "ccw" && v > 0 && (v = (v - P * oA) % P - ~~(v / P) * P)), Q._pt = T = new PQ(Q._pt, t, B, A, v, ni), T.e = c, T.u = "deg", Q._props.push(B), T;
}, lA = function(Q, t) {
  for (var B in t)
    Q[B] = t[B];
  return Q;
}, Hi = function(Q, t, B) {
  var A = lA({}, B._gsap), e = "perspective,force3D,transformOrigin,svgOrigin", P = B.style, r, s, v, c, n, T, z, a;
  ...
  for (s in OQ)
    v = A[s], c = r[s], v !== c && e.indexOf(s) < 0 && (z = _(v), a = _(c), n = z !== a ? gQ(B, s, v, a) : parseFloat(v), T = parseFloat(c), Q._pt = new PQ(Q._pt, r, s, n, T - n, lB), Q._pt.u = a || 0, Q._props.push(s));
  lA(r, A);
};
...
var de = {
  ...
  init: function(Q, t, B, A, e) {
    ...
    mB || uB(), this.styles = this.styles || Ee(Q), N = this.styles.props, this.tween = B;
    for (o in t)
      if (o !== "autoRound" && (c = t[o], !(cQ[o] && ie(o, t, B, A, Q, e)))) {
        if (z = typeof c, a = mt[o], z === "function" && (c = c.call(B, A, Q, e), z = typeof c), z === "string" && ~c.indexOf("random(") && (c = lt(c)), a)
          ...
          if (s && o in s ? (v = typeof s[o] == "function" ? s[o].call(B, A, Q, e) : s[o], Z(v) && ~v.indexOf("random(") && (v = lt(v)), _(v + "") || v === "auto" || (v += zQ.units[o] || _(CQ(Q, o)) || ""), (v + "").charAt(1) === "=" && (v = CQ(Q, o))) : v = CQ(Q, o), T = parseFloat(v), h = z === "string" && c.charAt(1) === "=" && c.substr(0, 2), h && (c = c.substr(2)), n = parseFloat(c), o in UQ && (o === "autoAlpha" && (T === 1 && CQ(Q, "visibility") === "hidden" && n && (T = 0), N.push("visibility", 0, r.visibility), FQ(this, r, "visibility", T ? "inherit" : "hidden", n ? "inherit" : "hidden", !n)), o !== "scale" && o !== "transform" && (o = UQ[o], ~o.indexOf(",") && (o = o.split(",")[0]))), u = o in OQ, u) {
            ...
            if (U || (k = Q._gsap, k.renderTransform && !t.parseTransform || Dt(Q, t.parseTransform), O = t.smoothOrigin !== !1 && k.smooth, U = this._pt = new PQ(this._pt, r, V, 0, 1, k.renderTransform, k, 0, -1), U.dep = 1), o === "scale")
              this._pt = new PQ(this._pt, k, "scaleY", k.scaleY, (h ? $Q(k.scaleY, h + n) : n) - k.scaleY || 0, lB), this._pt.u = 0, P.push("scaleY", o), o += "X";
            else if (o === "transformOrigin") {
              N.push(iQ, 0, r[iQ]), c = Ci(c), k.svg ? UB(Q, c, 0, O, 0, this) : (E = parseFloat(c.split(" ")[2]) || 0, E !== k.zOrigin && FQ(this, k, "zOrigin", k.zOrigin, E), FQ(this, r, o, xt(v), xt(c)));
              continue;
            } else if (o === "svgOrigin") {
              UB(Q, c, 1, O, 0, this);
              continue;
            } else if (o in ue) {
              Mi(this, k, o, T, h ? $Q(T, h + c) : c);
              continue;
          ...
          if (u || (n || n === 0) && (T || T === 0) && !ci.test(c) && o in r)
            w = (v + "").substr((T + "").length), n || (n = 0), E = _(c) || (o in zQ.units ? zQ.units[o] : w), w !== E && (T = gQ(Q, o, v, E)), this._pt = new PQ(this._pt, u ? k : r, o, T, (h ? $Q(T, h + n) : n) - T, !u && (E === "px" || o === "zIndex") && t.autoRound !== !1 ? zi : lB), this._pt.u = E || 0, u && d !== c ? (this._pt.b = v, this._pt.e = d, this._pt.r = Ti) : w !== E && E !== "%" && (this._pt.b = v, this._pt.r = oi);
          else if (o in r)
            di.call(this, Q, o, v, h ? h + c : c);
          else if (o in Q)
  ...
  getSetter: function(Q, t, B) {
    var A = UQ[t];
    return A && A.indexOf(",") < 0 && (t = A), t in OQ && t !== iQ && (Q._gsap.x || CQ(Q, "x")) ? B && nA === B ? t === "scale" ? hi : Ei : (nA = B || {}) && (t === "scale" ? li : ki) : Q.style && !CB(Q.style[t]) ? ai : ~t.indexOf("-") ? wi : pB(Q, t);
  },
  core: {
    _removeProperty: pQ,
    _getMatrix: IB
...
rQ.core.getStyleSaver = Ee;
(function(i, Q, t, B) {
  var A = eQ(i + "," + Q + "," + t, function(e) {
    OQ[e] = 1;
  });
  eQ(Q, function(e) {
    zQ.units[e] = "deg", ue[e] = 1;
...
function Ce(i) {
  const Q = atob(ji), t = new Uint8Array(Q.length);
  for (let v = 0; v < Q.length; v++) t[v] = Q.charCodeAt(v);
  const A = new je().parse(t.buffer);
  ...
  return A.translate(
    ...
    -(s.min.y + s.max.y) / 2,
    -s.min.z
  ), gi(A, 6), A.computeVertexNormals(), A;
}
let tB = null;
function mi() {
  if (tB) return tB;
  ...
  return P.wrapS = l.RepeatWrapping, P.wrapT = l.RepeatWrapping, tB = P, P;
}
function xi(i, Q) {
...
function yi(i) {
  ...
  return i.bit.type === "triangle" ? bi(Q) : i.bit.type === "drill" ? Ce(Q) : pi(Q);
}
function SB(i) {
  return i.bit.colorSource === "custom" ? i.bit.color : i.bit.type === "drill" ? fi : Fi;
}
function Ii(i) {
  const Q = Ct(i.bit.opacity), t = Ce(Math.max(1e-3, i.bit.size)), B = new l.Color(SB(i)), A = mi(), e = new l.MeshStandardMaterial({
    color: B,
    metalness: 0.8,
    roughness: 0.35,
    roughnessMap: A,
...
function Si(i) {
  const Q = Ct(i.bit.opacity), t = yi(i), B = new l.MeshBasicMaterial({
    color: new l.Color(SB(i)),
    transparent: Q < 1,
    opacity: Q,
    side: l.DoubleSide,
    depthTest: !1,
...
function UA(i) {
  return i.bit.type === "laser" ? xi(i.bit.size, i.bit.opacity) : i.bit.type === "drill" ? Ii(i) : Si(i);
}
function DA(i) {
...
function Yi(i) {
  ...
  const v = (n) => {
    ...
    if (w || E)
      Q.remove(B), DA(B), B = UA(n), Q.add(B), r == null || r.kill(), P == null || P.kill(), P = s(n.bit.spinRpm), e && P.timeScale(1).play();
    else if (T === "laser") {
      const U = B, [k, O] = U.children, D = k.material, N = O.material;
      D.opacity = h, D.needsUpdate = !0, N.opacity = h * 0.3, N.needsUpdate = !0;
    } else {
      const k = B.material, O = new l.Color(SB(n));
  ...
  return {
    ...
    update: (n) => {
      if (!A) return;
      const T = (n - A.startedAt) / A.duration, z = Gi(T);
      Q.position.set(
    ...
    dispose: () => {
      r == null || r.kill(), P == null || P.kill(), Q.remove(B), DA(B);
    }
  };
}
const Vi = 25.4, Ji = 500, Ri = 300;
class tr {
  constructor(Q) {
    this.viewCube = null, this.resizeObserver = null, this.onWindowResize = null, this.animationFrameId = null, this.gridGroup = null, this.axesGroup = null, this.gridLabelsGroup = null, this.boundingBoxGroup = null, this.machineBedGroup = null, this.bitMarker = null, this.preLaserBitType = "drill", this.toolpathStreams = [], this.toolpathCutBucketCount = 1, this.toolpathRotationA = 0, this.lastBitPosition = { x: 0, y: 0, z: 0, a: 0 }, this.sim3dHandle = null, this.currentLines = [], this.linePositions = null, this.renderSequence = 0, this.currentBounds = null, this.cameraFocusTransition = null, this.cameraFollowRequested = !1, this.cameraFollowInterrupted = !1, this.cameraFollowOffset = null, this.id = Q.id, this.container = Q.container, this.callbacks = Q.callbacks ?? {}, this.options = CA(xe, Q.options), this.canvas = document.createElement("canvas"), this.canvas.style.width = "100%", this.canvas.style.height = "100%", this.canvas.style.display = "block", this.container.appendChild(this.canvas), AP(this.container), this.renderer = new l.WebGLRenderer({
      canvas: this.canvas,
    ...
    Object.assign(this.perspectiveCamera, $B(e)), this.perspectiveCamera.updateProjectionMatrix(), Object.assign(
      ...
      Rt(this.orthoViewHeight, 1),
      QA(e, e)
    ), this.orthographicCamera.updateProjectionMatrix(), this.camera = this.options.camera.projection === "orthographic" ? this.orthographicCamera : this.perspectiveCamera, this.controls = new BP(this.camera, this.renderer.domElement), this.controls.enableDamping = this.options.camera.orbit.enableDamping, this.controls.addEventListener("start", () => {
  ...
  setBitPosition(Q, t) {
    ...
    if (this.ensureBitMarker(), this.lastBitPosition = { ...this.lastBitPosition, ...Q }, (B = this.bitMarker) == null || B.setTarget(Q, t), this.cameraFollowRequested && !this.cameraFollowInterrupted && this.cameraFollowOffset) {
      ...
      this.startCameraLerp(A, e, Ri, "linear");
    }
  }
  /**
  ...
  hideUntilLine(Q, t) {
    ...
    for (const e of this.toolpathStreams) {
      ...
      B === "grey" ? (e.line.geometry.setDrawRange(0, e.totalVertices), pe({ stream: e, nextCursorVertex: P, options: this.options })) : e.line.geometry.setDrawRange(P, Math.max(0, e.totalVertices - P));
    }
  }
  seekToLine(Q, t) {
    ...
    if (this.sim3dHandle) {
      ...
      if (B !== this.sim3dHandle.currentLine) {
        const A = Yt(B, this.sim3dHandle.data);
        Vt(A, this.sim3dHandle.data.resolution, this.options.sim3d.erosionPasses, this.sim3dHandle.data.slabBounds.zTop), Jt(this.sim3dHandle.slab, A), this.sim3dHandle.currentLine = B;
      }
    }
  }
  showAll() {
  ...
  screenToWorld(Q, t, B) {
    ...
    const r = (B == null ? void 0 : B.planeZ) ?? this.lastBitPosition.z ?? 0, s = iP(
      P.ray.origin,
      P.ray.direction,
      r,
  ...
  applyCameraDepthRange(Q) {
    ...
    Object.assign(this.perspectiveCamera, $B(t)), Object.assign(this.orthographicCamera, QA(t, t)), this.perspectiveCamera.updateProjectionMatrix(), this.orthographicCamera.updateProjectionMatrix();
  }
  /**
  ...
  setActiveProjection(Q) {
    ...
    if (t) {
      const P = this.orthoFramedHeight(), r = Math.max(1e-6, OA(P, this.options.camera.fov)), s = this.camera.position.clone().sub(B).normalize();
  ...
  startSnapToView(Q, t, B, A, e = !1) {
    const P = qB(Q), r = t.clone().add(P.multiplyScalar(B));
  ...
  async loadFromWorkerData(Q, t) {
    this.currentLines = [];
    const { rapids: B, cuts: A } = Oe(Q, t), e = (Q.toolchangeCount ?? 0) > 0;
  ...
  setOptions(Q) {
    var T, z, a, o, w, E, h, u, U, k, O, D, N, d, M, b, G, C, j, F, H, f, I, R, QQ, sQ, W, x, tQ, vQ, rt, YB, VB, JB;
    const t = this.options;
    this.options = CA(this.options, Q), (t.render.antialias !== this.options.render.antialias || t.render.theme.background !== this.options.render.theme.background) && this.renderer.setClearColor(this.options.render.theme.background, 1), (t.render.theme.opacity !== this.options.render.theme.opacity || t.render.theme.rapidOpacity !== this.options.render.theme.rapidOpacity) && this.refreshToolpathOpacities(), t.camera.fov !== this.options.camera.fov && (this.perspectiveCamera.fov = this.options.camera.fov, this.perspectiveCamera.updateProjectionMatrix()), t.camera.projection !== this.options.camera.projection && this.setActiveProjection(this.options.camera.projection), t.camera.orbit.enableDamping !== this.options.camera.orbit.enableDamping && (this.controls.enableDamping = this.options.camera.orbit.enableDamping);
    ...
    if (t.sim3d.erosionPasses !== this.options.sim3d.erosionPasses && this.sim3dHandle) {
      const Ne = this.sim3dHandle.currentLine, RB = Yt(Ne, this.sim3dHandle.data);
      Vt(RB, this.sim3dHandle.data.resolution, this.options.sim3d.erosionPasses, this.sim3dHandle.data.slabBounds.zTop), Jt(this.sim3dHandle.slab, RB);
    }
  ...
  resize() {
    ...
    const A = t / B;
    this.perspectiveCamera.aspect = A, this.perspectiveCamera.updateProjectionMatrix(), Object.assign(this.orthographicCamera, Rt(this.orthoViewHeight, A)), this.orthographicCamera.updateProjectionMatrix();
  }
  focusToModel() {
  ...
  ensureBitMarker() {
    this.bitMarker || (this.bitMarker = Yi(this.options), this.scene.add(this.bitMarker.object));
  }
  worldSizes() {
    const Q = this.options.units === "in" ? Vi : 1;
    return {
  ...
  refreshGridLabels() {
    ...
    this.setGridLabelsGroup(
      nP({ sizeXMm: Q, sizeYMm: t, bounds: B, units: this.options.units, theme: this.options.render.theme })
    );
  }
  refreshBoundingBox() {
  ...
  refreshMachineBed() {
    ...
    this.setMachineBedGroup(QP(t, B, this.options, A));
  }
  setBitMarker(Q) {
  ...
  setGridGroup(Q) {
    this.gridGroup && (this.scene.remove(this.gridGroup), sP(this.gridGroup), this.gridGroup = null), Q && (this.gridGroup = Q, this.scene.add(Q));
  }
  setAxesGroup(Q) {
    this.axesGroup && (this.scene.remove(this.axesGroup), cP(this.axesGroup), this.axesGroup = null), Q && (this.axesGroup = Q, this.scene.add(Q));
  }
  setGridLabelsGroup(Q) {
    this.gridLabelsGroup && (this.scene.remove(this.gridLabelsGroup), Ke(this.gridLabelsGroup), this.gridLabelsGroup = null), Q && (this.gridLabelsGroup = Q, this.scene.add(Q));
  }
  setBoundingBoxGroup(Q) {
    this.boundingBoxGroup && (this.scene.remove(this.boundingBoxGroup), _e(this.boundingBoxGroup), this.boundingBoxGroup = null), Q && (this.boundingBoxGroup = Q, this.scene.add(Q));
  }
  setMachineBedGroup(Q) {
    this.machineBedGroup && (this.scene.remove(this.machineBedGroup), tP(this.machineBedGroup), this.machineBedGroup = null), Q && (this.machineBedGroup = Q, this.scene.add(Q));
  }
  setGeometryEmpty() {
  ...
  async renderScene() {
    ...
    try {
      ...
      const t = await Le(this.currentLines, {
  ...
  setSim3dHandle(Q) {
    this.sim3dHandle && (this.scene.remove(this.sim3dHandle.slab.group), Ve(this.sim3dHandle.slab), this.sim3dHandle = null), Q && (this.sim3dHandle = Q, this.scene.add(Q.slab.group));
  }
  ...
  async buildAndApplySim3d(Q) {
    ...
    const e = Yt(0, A);
    Vt(e, B, this.options.sim3d.erosionPasses, A.slabBounds.zTop);
    const P = Ye(A.slabBounds, B);
    Jt(P, e), this.setSim3dHandle({ data: A, slab: P, currentLine: 0 });
  }
  startCameraFocus(Q) {
    ...
    Q.getSize(B);
    const A = _B(B, this.options.camera.fov), e = qB("front-top-left"), P = t.clone().add(e.multiplyScalar(A));
  ...
  updateCameraFocusTransition() {
    if (!this.cameraFocusTransition)
      return;
    const t = performance.now() - this.cameraFocusTransition.startedAt, B = Math.min(1, Math.max(0, t / this.cameraFocusTransition.duration)), A = this.cameraFocusTransition.easing === "linear" ? B : eP(B);
  ...
  updateViewCubeRotation() {
    ...
    const B = PP(this.camera.position, this.controls.target);
...
function CA(i, Q) {
  ...
  if (!Q)
    return { ...i };
  const t = Xi(i.render.theme, (B = Q.render) == null ? void 0 : B.theme);
  return {
    ...i,
    ...Q,
    mode: { ...i.mode, ...Q.mode },
...
class Br {
  constructor(Q, t) {
    this.crosshairPos = null, this.crosshairVisible = !1, this.pathEls = [], this.segmentGroups = [], this.workerMode = !1, this.viewBox = { x: 0, y: 0, w: 100, h: 100 }, this.rotX = vt, this.rotY = ct, this.centerX = 0, this.centerY = 0, this.centerZ = 0, this.focalLength = 500, this.cosRotX = 1, this.sinRotX = 0, this.cosRotY = 1, this.sinRotY = 0, this.dragMode = "none", this.activePointers = /* @__PURE__ */ new Map(), this.pinchLastDist = 0, this.pinchLastMid = { x: 0, y: 0 }, this.rafPending = !1, this.overlayRafPending = !1, this.rapidVerts = new Float32Array(0), this.cutVerts = new Float32Array(0), this.bounds = { minX: 0, minY: 0, maxX: 0, maxY: 0, minZ: 0, maxZ: 0, empty: !0 }, this.hasZInfo = !0, this.project = (B, A, e) => {
      ...
      B.preventDefault();
    }, this.options = { ...Ki, ...t }, this.svg = document.createElementNS("http://www.w3.org/2000/svg", "svg"), this.svg.style.cssText = "width:100%;height:100%;display:block;cursor:grab;user-select:none;touch-action:none;", this.svg.setAttribute("preserveAspectRatio", "xMidYMid meet"), this.svg.setAttribute("xmlns", "http://www.w3.org/2000/svg"), this.bboxPath = BB(), this.pathLayer = document.createElementNS("http://www.w3.org/2000/svg", "g"), this.bboxLabelX = AB("middle", "hanging"), this.bboxLabelY = AB("start", "middle"), this.bboxLabelZ = AB("middle", "auto"), this.originMarker = document.createElementNS("http://www.w3.org/2000/svg", "circle"), this.originMarker.setAttribute("stroke-opacity", "0.4"), this.originMarker.setAttribute("visibility", "hidden"), this.crosshairEl = BB(), this.crosshairEl.setAttribute("fill", "none"), this.crosshairEl.setAttribute("visibility", "hidden"), this.svg.appendChild(this.bboxPath), this.svg.appendChild(this.pathLayer), this.svg.appendChild(this.bboxLabelX), this.svg.appendChild(this.bboxLabelY), this.svg.appendChild(this.bboxLabelZ), this.svg.appendChild(this.originMarker), this.svg.appendChild(this.crosshairEl), Q.appendChild(this.svg), this.applyOptions(), this.bindEvents();
  }
  // ── Public API ────────────────────────────────────────────────────────────
  loadFromLines(Q) {
    const { rapid: t, cutting: B } = Me(Q, {
      arcSegments: this.options.arcSegments
    });
    if (this.rapidVerts = t, this.cutVerts = B, this.workerMode = !1, this.syncSegmentGroupsFromLines(), this.hasZInfo = !0, this.bounds = PB([
      { verts: t, stride: 6 },
      { verts: B, stride: 6 }
    ]), !this.bounds.empty) {
  ...
  loadFromWorkerData(Q) {
    ...
    if (this.workerMode = !0, this.rapidVerts = new Float32Array(0), this.cutVerts = new Float32Array(0), this.segmentGroups = t.map((B) => ({
      ...
      verts: B.positions,
      stride: 6
    })), this.hasZInfo = !0, this.bounds = PB(t.map((B) => ({ verts: B.positions, stride: 6 }))), !this.bounds.empty) {
      this.centerX = (this.bounds.minX + this.bounds.maxX) / 2, this.centerY = (this.bounds.minY + this.bounds.maxY) / 2, this.centerZ = (this.bounds.minZ + this.bounds.maxZ) / 2;
      const B = Math.hypot(
        this.bounds.maxX - this.bounds.minX,
        this.bounds.maxY - this.bounds.minY,
  ...
  loadFromPrecomputedGroups(Q, t) {
    this.workerMode = !0, this.rapidVerts = new Float32Array(0), this.cutVerts = new Float32Array(0), this.segmentGroups = Q.map((A) => ({
      ...
      stride: A.stride ?? 6
    })), this.bounds = PB(this.segmentGroups);
  ...
  rebuildToolpaths(Q = !1) {
    const t = Q ? Zi : L, B = String(this.options.strokeWidth), A = this.simplifyTolerance();
    ...
    for (let e = 0; e < this.segmentGroups.length; e++) {
      ...
      c.setAttribute("stroke", P), c.setAttribute("stroke-opacity", String(r)), c.setAttribute("stroke-width", B), c.setAttribute("stroke-linecap", "round"), c.setAttribute("stroke-linejoin", "round"), c.setAttribute(
        "d",
        v === 4 ? Wi(s, t, A) : qi(s, this.project, t, A)
      );
    }
  }
  ...
  renderBbox() {
    ...
    if (this.options.projectionMode === "top") {
      ...
      ZQ(this.bboxLabelX, LQ(C, j), eB(LQ(C, j), LQ(F, H), QQ), R, `X: ${WQ(t - Q)}`);
    ...
    ZQ(this.bboxLabelX, LQ(s, v), eB(LQ(s, v), LQ(c, n), k), U, `X: ${WQ(t - Q)}`);
