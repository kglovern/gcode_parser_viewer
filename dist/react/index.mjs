...
// src/react/GCodeVisualizer.tsx
var GCodeVisualizer = React.forwardRef(
  function GCodeVisualizer2(props, ref) {
    ...
    React.useImperativeHandle(
      ...
      () => {
        ...
        const handle = {
          ...
          snapCameraToView(view, options2) {
            getViewer().snapCameraToView(view, options2);
          },
          setBitPosition(position, options2) {
            getViewer().setBitPosition(position, options2);
          },
          setBitVisible(visible) {
